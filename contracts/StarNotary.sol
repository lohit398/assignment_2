...
contract StarNotary is ERC721 {
    ...
    {
        Star memory st = tokenIdToStarInfo[_tokenId];
        return st.name;
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "Sender isn't owner of any of the stars passed"
        );
        //2. You don't have to check for the price of the token (star)

        address token_1_owner = ownerOf(_tokenId1);
        address token_2_owner = ownerOf(_tokenId2);
        //3. Get the owner of the two tokens (ownerOf(_tokenId1), ownerOf(_tokenId2)

        transferFrom(token_1_owner, token_2_owner, _tokenId1);
        transferFrom(token_2_owner, token_1_owner, _tokenId2);
